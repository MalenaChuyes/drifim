...
<body>
		...
		<div class="texto">
				<p>En este apartado puedes encontrar material de ciclos pasados de cada curso disponible,
					desde syllabus, slides, pdfs, prácticas, hasta exámenes parciales, finales y grabaciones
					de las clases.
				</p>
		</div>
